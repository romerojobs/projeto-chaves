...
<body>
    ...
    <div class="container text-center" style = "width:998px">
            ...
            <form action="trocarsenhastore" method="get" class = "mt-5">
                @csrf
                <div class="mb-4 mt-4 d-flex flex-column align-items-center">
                    <label for="" class="form-label"><h5>Digite a sua senha antiga: </h5></label>
                    <input type="password" style = "width:20rem" name="senhaantiga" id="senhaantiga" class="form-control mb-3" placeholder="" aria-describedby="helpId">
