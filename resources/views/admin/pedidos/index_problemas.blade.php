...
<head>
    ...
    <title>Problemas em Laboratórios</title>
 ...
 <!-- CABEÇALHO -->
    ...
    <div class="container justify-content-center align-items-center " style = "width:998px">
        <div class="container text-center">
            <h3 class="m-3" >Problemas de laboratórios (atuais)</h3>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                        @foreach($pedidos as $pedido)
                                <tr>
                                    <td>
                                        {{$pedido->chave->nomelab}}
                                    </td>
                                    <td>
                                        {{$pedido->observacoes}}
                                    </td>
                                    <td>
                                        <a href="{{route('deleteProblema',['problema_excluir' => $pedido->id])}}">Problema resolvido</a>
                                    </td>
                                </tr>
                        @endforeach
                </tbody>
